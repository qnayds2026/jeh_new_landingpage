...
export default function HeroVideo() {
  ...
  return (
    <div>
      <div className="overflow-hidden rounded-2xl border border-[#EAEDEA]/10 bg-[#121412]">
        <div className="flex items-center justify-between border-b border-[#EAEDEA]/10 px-4 py-3 text-xs text-[#A3A9A3]">
      ...
      <div className="mt-6 grid grid-cols-3 gap-4">
        <div className="rounded-xl border border-[#EAEDEA]/10 p-4 text-center">
          <GraduationCap className="mx-auto text-[#3FA66E]" size={20} />
          <h4 className="mt-2 font-serif text-lg">8+ Yrs</h4>
          <p className="text-xs text-[#A3A9A3]">Experience</p>
        </div>
        <div className="rounded-xl border border-[#EAEDEA]/10 p-4 text-center">
          <ShieldCheck className="mx-auto text-[#3FA66E]" size={20} />
          <h4 className="mt-2 font-serif text-lg">50+</h4>
          <p className="text-xs text-[#A3A9A3]">Tools Covered</p>
        </div>
        <div className="rounded-xl border border-[#EAEDEA]/10 p-4 text-center">
          <Star className="mx-auto fill-[#3FA66E] text-[#3FA66E]" size={20} />
          <h4 className="mt-2 font-serif text-lg">4.6/5</h4>
          <p className="text-xs text-[#A3A9A3]">Mentor Rating</p>
        </div>
      </div>

      {/* Info box */}
      <div className="mt-6 rounded-xl border border-[#EAEDEA]/10 bg-[#121412] p-6">
        <h4 className="font-serif text-lg font-medium">What you'll discover</h4>
        <div className="mt-4 space-y-3 text-[#A3A9A3]">
